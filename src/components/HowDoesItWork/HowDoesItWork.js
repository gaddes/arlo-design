  ...
  >
    ...
    <ul className="list">
      <li>
        <b>Business goals</b>
        {' '}
        - Where do you see your business in the next 12 months? What currently brings in the most revenue, and where would you like to focus our efforts?
      </li>
      <li>
        <b>Branding</b>
        {' '}
        - Would you like to use your existing branding? Do you want to build a brand from scratch?
      </li>
      <li>
        <b>Budget</b>
        {' '}
        - What&apos;s your budget for this project? We&apos;ll openly discuss our rates to ensure they align with your expectations.
      </li>
      <li>
        <b>Timeframe</b>
        {' '}
  ...
  >
    ...
    <ol className="list">
      <li>
        <b>Initial design</b>
        {' '}
        - We&apos;ll sketch a wireframe layout to position your content on the page. We design responsively to ensure your site looks great on all size devices.
      </li>
      <li>
        <b>Detailed design</b>
        {' '}
        - Your imagery and brand colors will be added. We&apos;ll issue a prototype for your review before diving in to development.
      </li>
    </ol>
  </Card>,
